...
//    fun getAllDummyContents(): ArrayList<ContentEntity> = ArrayList<ContentEntity>().apply {
//        addAll(getDummyMovies())
//        addAll(getDummyTvShows())
//    }
//
//    fun getDummyMovies(): ArrayList<ContentEntity> = ArrayList<ContentEntity>().apply {
//        add(
//            ContentEntity(
//                "m01",
//                "Godzilla vs. Kong",
...
//
//
//    fun getDummyTvShows(): ArrayList<ContentEntity> = ArrayList<ContentEntity>().apply {
//        add(
//            ContentEntity(
//                "tv01",
